...
exports.SalaryResolver = void 0;
const graphql_1 = require("@nestjs/graphql");
const salary_service_1 = require("./salary.service");
let SalaryResolver = class SalaryResolver {
    constructor(salaryService) {
        this.salaryService = salaryService;
    }
};
exports.SalaryResolver = SalaryResolver;
exports.SalaryResolver = SalaryResolver = __decorate([
